...
public class UtilisateurDAOImp implements UtilisateurDAO {
    ...
    public Optional<Utilisateur> chercherUtilisateurParId(long idUtilisateur) {
        String sql =
                "Select id_utilisateur, pseudo, mdp, nom, prenom, email from utilisateur where id_utilisateur =1";
        Optional<Utilisateur> optCategorie = Optional.empty();
                    ...
                    jdbcTemplate.queryForObject(
                            ...
                            (ResultSet rs, int rowNum) ->
                                    new Utilisateur(
                                            ...
                                            rs.getString(6)),
                            idUtilisateur);
            optCategorie = Optional.of(utilisateur);
